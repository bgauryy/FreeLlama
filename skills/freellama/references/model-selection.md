...
Load when choosing a model for a task, finding one you do not have yet, or configuring `route` so
...
## Finding a model you do not have — `search_models`, two steps
...
|---|---|---|---|---|
| `qwen3.8:27b-mlx` | 18GB | **8/8** grounded lookups @ 11.8s median · 7/10 real-repo · 86.7% on the 30-question suite | UI/chart ✓, transcription ✓ | **Default for everything** — best accuracy *and* fastest |
